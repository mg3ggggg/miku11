...
function _0x37ed() {
    const _0x3dc004 = ['exception', 'dfail', 'chat', 'warn', 'user', 'length', 'jid', '╮───────────────╭ـ\x0a│ *➣ الميزه دي للمطور بس! ┇❌*\x0a╯───────────────╰ـ', 'MIKO - ʙᴏᴛ', '6577104yIJAGo', 'toString', 'key', 'prototype', 'log', '60084PmHsGo', 'error', 'table', 'bind', '__proto__', '310ZzthQa', 'console', '{}.constructor(\"return this\")( )', '3988908gGrilS', '22vYpRlj', '*╮───────────────╭ـ\x0a│ *➣ تم الغاء الأمر من قبل المطور! ┇👑*\x0a╯───────────────╰ـ', '457880gZDddd', '73914JpAoTP', '3114EljcOm', '4pLipEX', '7PMNNsd', '╮───────────────╭ـ\x0a│ *➣ الميزه ذي للأعضاء المميزين فقط! ┇❌*\x0a╯───────────────╰ـ', '╮───────────────╭ـ\x0a│ *➣ الميزه ذي للادمنز - المشرفين فقط! ┇❌*\x0a╯───────────────╰ـ', '╮───────────────╭ـ\x0a│ *➣ الميزه ذي في الخاص  فقط! ┇❌*\x0a╯───────────────╰ـ', '411988yPwWvN', '*[ لحظة !! انت مو مسجل ]*\x0a\x0a*『 سجل الامر عشان تفعله 』*\x0a*➣ #تفعيل الاسم.السن\x0a*➣مثل : #تفعيل سوكونا.18', '╮───────────────╭ـ\x0a│ *➣ ارفع البوت ادمن الاول! ┇❌*\x0a╯───────────────╰ـ', 'message', '1310arcNMM'];
    _0x37ed = function () {
        return _0x3dc004;
    };
    return _0x37ed();
