...
export async function callUpdate(callUpdate) {
    ...
    let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;MIKO┇👑;;;\nFN:MIKU┇👑\nORG:MIIKU┇👑\nTITLE:\nitem1.TEL;waid=96877432137:+96877432137\nitem1.X-ABLabel:MIKU┇👑\nX-WA-BIZ-DESCRIPTION:[❗] تكلم مع المطور اذا كان لديك مشكله ما.+96877432137\nNAME:MIKO┇👑`
    await this.sendMessage(nk.from, { contacts: { displayName: '𝐕𝐄𝐍𝐎𝐌┇👑', contacts: [{ vcard }] }}, {quoted: callmsg})
...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: '*『 الميزه للمطور فقط! 』*',
        owner: '*『 الميزه للمطور فقط  ! 』*',
        mods: '*『 الميزه لمالك البوت فقط ! 』*',
        premium: '*『 الميزه للاعضاء المميزين فقط ! 』*',
        group: '*[ ⚠️ ملاحظه ⚠️ ] هذا الامر في الجروبات فقط*',
    ...
    let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: '[ ⚠ ] تـنـبـيـه', body: 'MIKO 𝒃𝒐𝒕🧡', thumbnail: imagen1, sourceUrl: 'https://wa.me/+96877432137' }}}}, aa)
