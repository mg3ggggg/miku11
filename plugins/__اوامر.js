...
let { fancytext, tlang, tiny, runtime, formatp, botpic, prefix, sck1 } = require("../lib/levelling.js");
...
*✦*`
                str += `*❄️⃝🧚‍♀️│· • • ━ ⊰❄️⊱ ━ • • ·│❄️⃝🧚‍♀️*
*┇❄️ ""اهـلاً بـك فـي أوامـر الـبـوت الـكـيـوت ميكو "" ❄️┇*

*❄️⃝🧚‍♀️ اسـم الـبـوتـه 🤖 ⦂『ميكو』*
